...
public class AgreeInfoActivity extends ParentActivity {
    ...
    SlideMenuController.DEFAULT_STATE = 0;
		...
		LayoutInflateController.inflateLayout(this, R.layout.activity_agree_info);
	...
	public void initView() {
		...
		// 약관
		CharSequence url = getText(R.string.touchnedu_agree);
